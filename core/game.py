...
class Game:
    ...
    def __init__(self):
        ...
        pygame.mixer.music.load('assets/music/background3.mp3')
        pygame.mixer.music.play(loops=-1)

        # ładowanie dźwięków końca gry i wygranej
        self.end_sound = pygame.mixer.Sound('assets/music/end.mp3')
        self.win_sound = pygame.mixer.Sound('assets/music/win.mp3')
        ...
        self.images = load_images(os.path.join(os.getcwd(), 'assets/images'))
